...
args.experiment_name = 'matched-pca' #'Data_RandProj_20pcs_150frames', Data_20pcs_150frames
...
# %%
# -- load dataset
dataloaders, scaling_factor, Train_Data_indices, Val_Data_indices = create_dataloaders_ours(path_file=r"/users/ztang47/githubs/PlanB/schiebinger2019/large_test/matched-pca", 
...
path_to_save_models = path_to_experiment+'/version_'+str(test_version)
num_experiments = test_version
...
train_cfg = {
    ...
    "use_mse":True,
    "std_noise_t": 0.,
    "std_to_data": 0., # no noise during inference
    "resume_from_checkpoint": f"version_{test_version}",
}
